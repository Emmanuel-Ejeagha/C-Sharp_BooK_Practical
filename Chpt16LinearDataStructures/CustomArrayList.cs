...
namespace Chpt16LinearDataStructures;
...
public class CustomArrayList<T>
{
    ...
    /// <summary>Adds elements to the list</summary>
    /// <param name=""item">The element you wnat to add </param>
    ...
    ///<summary>Insert the specified element at a given position in this list<summary>
    /// <param name="index">Index, at which the specifiied element is to be inserted</param>
    ...
    /// <summary>
    /// Dobles the of thi.arr (grow) ifit is full
    /// </summary
    ...
    public static void CustomArrayListTest()
    {
